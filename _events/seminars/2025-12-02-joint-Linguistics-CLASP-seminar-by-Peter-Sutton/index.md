---
presented_by: "Peter Sutton from Potsdam University"
title: "Informational nouns: Nominal complementiser clauses and polysemy"
type: seminar
...
(2)	 The propositional noun-related complementiser clause environment (COMP). Examples:
a.	 the allegation/belief/evidence/fact/information/report/statement that Bilbo found the ring
b.	#the house that Bilbo met Gandalf
c.	#the event/celebration that Gandalf set off fireworks
d.	#the book/newspaper that Bilbo found the ring
